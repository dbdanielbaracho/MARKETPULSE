...
from app.services.runtime_control import append_tracking, effective_provider
...
def test_control_plane_draft_does_not_change_published(tmp_path):
    ...
    payload["providers"]["kalshi"]["partner_id"] = "partner-1234"
    payload["providers"]["kalshi"]["commercial_verified"] = True
    payload["providers"]["kalshi"]["tracking_parameter"] = "ref"
    payload["providers"]["kalshi"]["tracking_value"] = "abc"

    saved = store.save_draft(payload, "tester")
    assert saved["draft"]["providers"]["kalshi"]["partner_id"] == "partner-1234"
    assert saved["published"]["providers"]["kalshi"]["partner_id"] == ""
