...
| MP-013 | Automated AI content candidates | IN_PROGRESS | evidence-gated classifier, deploy-durable SQLite queue, guarded states, audit trail and immutable evidence snapshots; controlled generation pending |
