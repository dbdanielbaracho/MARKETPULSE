...
| MP-013 | Automated AI content candidates | IN_PROGRESS | evidence-gated classifier, durable audited queue, immutable evidence snapshots and citation-locked drafts pending review; AI-provider integration pending |
