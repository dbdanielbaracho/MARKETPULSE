...
| MP-014 | Automated website publishing | IN_PROGRESS | fail-closed authenticated review plus manual publication API, immutable version/citations, public article views and audited rollback; admin publishing UI, scheduling and automated worker remain pending |
