...
| MP-032 | Partner economics never invented; require evidence/config | VERIFIED | server-side fail-closed commercial configuration validation plus privacy/routing regressions; see `docs/evidence/PARTNER_ECONOMICS_VALIDATION.md` |
