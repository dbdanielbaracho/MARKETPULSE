...
| MP-037 | Preserve PrediBeacon while external venue opens separately | IN_PROGRESS | CTA uses target=_blank with noopener/noreferrer and a dedicated production-browser acceptance now runs from the production smoke workflow; post-merge live pass is required before terminal verification |
