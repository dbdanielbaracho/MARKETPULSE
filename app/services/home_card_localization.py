...
(()=>{
 ...
 const catalog={
   en:{open:'Open',closed:'Closed',why:'Why it matters:',volume:'Volume',closes:'Closes in',trend:'Trend',analysis:'View PrediBeacon analysis',watch:'Watch',watching:'Watching',market:'market',markets:'markets',unavailable:'Unavailable',changeUnavailable:'Change unavailable'},
   'pt-br':{open:'Aberto',closed:'Encerrado',why:'Por que importa:',volume:'Volume',closes:'Fecha em',trend:'Relevância',analysis:'Ver análise PrediBeacon',watch:'Acompanhar',watching:'Acompanhando',market:'mercado',markets:'mercados',unavailable:'Indisponível',changeUnavailable:'Variação indisponível'},
   es:{open:'Abierto',closed:'Cerrado',why:'Por qué importa:',volume:'Volumen',closes:'Cierra en',trend:'Relevancia',analysis:'Ver análisis PrediBeacon',watch:'Seguir',watching:'Siguiendo',market:'mercado',markets:'mercados',unavailable:'No disponible',changeUnavailable:'Variación no disponible'}
 };
 ...
 function localize(card){
   ...
   const move=card.querySelector('.move');setExact(move,['Change unavailable','Variação indisponível','Variación no disponible'],t.changeUnavailable);
